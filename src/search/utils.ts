...
const CONCEPT_FAMILIES: ConceptFamilyDefinition[] = [
  ...
  {
    family: "billing",
    anchors: ["billing", "payment", "invoice", "subscription", "checkout", "refund", "credit", "credits"],
    aliases: [
      "billing",
      "payment",
      "payments",
  ...
  {
    family: "workflow",
    anchors: ["flow", "workflow", "editor", "publish", "save", "serialization"],
    aliases: [
      "flow",
      "workflow",
      "editor",
  ...
  {
    family: "bot",
    anchors: ["bot", "telegram", "discord", "whatsapp", "chat", "message"],
    aliases: [
      "bot",
      "telegram",
      "discord",
